...
(function() {
  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype.started = function() {
        return this.getState("current_step") && !this.ended();
      };

      Tour.prototype.autoRestart = function() {
    	  var step = this.getStep(this._current);
    	  var onPage = (step.path !== "" && (document.location.pathname == step.path || document.location.pathname.replace(/^.*[\\\/]/, '') == step.path));
          return (this.started() && onPage);
      };
      ...
      Tour.prototype._scrollIntoView = function(tip) {
        ...
        if (!(tipRect.top > 0 && tipRect.bottom < $(window).height() && tipRect.left > 0 && tipRect.right < $(window).width())) {
        	console.log(tip.get(0));
          var r = tip.get(0).scrollIntoView(true);
          var re=/html$/i;
          var el = tip.get(0);
          while(!re.test(el.tagName) && (1 > el.scrollTop)) el=el.parentNode;
          if(0 < el.scrollTop) el.scrollTop -= 80;
          return r;
        }
      };
